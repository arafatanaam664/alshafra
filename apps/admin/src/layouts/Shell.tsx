...
const NAV: { href?: string; label: string; perm?: string; soon?: boolean; group: string }[] = [
  ...
  { group: 'اجتماعي', href: '/social', label: 'طابور النشر', perm: 'social.publish' },
  { group: 'أتمتة', href: '/automation', label: 'الأتمتة', perm: 'automation.edit' },
  { group: 'أتمتة', href: '/notifications', label: 'الإشعارات' },
  { group: 'أتمتة', href: '/ads', label: 'الإعلانات', perm: 'settings.read' },
