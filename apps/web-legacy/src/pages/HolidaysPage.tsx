      ...
      <section className="mt-10 card p-6 sm:p-8">
        ...
        <div className="mt-3 space-y-3 text-sm leading-relaxed text-brand-700/85">
          <p>
            ...
            النظامية الأساسية (عيد الفطر وعيد الأضحى) والإجازات الوطنية
            (يوم التأسيس واليوم الوطني)، مع إجازات دراسية مستقلة وفق تقويم وزارة التعليم. رأس السنة الهجرية والمولد ويوم العلم مناسبات وليست إجازات عامة تلقائية.
          </p>
          <p>
