...
> **تحديث 2026-08-21:** هذه الوثيقة تصف **الموقع الحي القديم فقط** (تطبيق Vite في جذر المستودع سابقاً، والآن `apps/web-legacy/`).
> المنصة الجديدة اسمها **Alshafra** وتضم ثماني أفكار (سبع من الدردشة + التقويم كفكرة ثامنة).
> اقرأ أولاً: `README.md` و`docs/product_architecture/56-eight-pillars.md` و`docs/execution/03-owner-decisions.md`.
> لا تشغّل أوامر تفترض أن `src/` ما زال في جذر المستودع.
