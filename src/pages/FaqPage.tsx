...
const FAQ_GROUPS: { title: string; items: QA[] }[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'تُودع رواتب المتقاعدين في اليوم الأول من كل شهر ميلادي وفق المؤسسة العامة للتأمينات الاجتماعية، مع تطبيق قاعدة نهاية الأسبوع.',
      },
      {
    ...
    items: [
      {
        ...
        a: 'يبدأ العام الهجري 1448هـ في 1 محرم 1448هـ الموافق 16 يونيو 2026م تقريباً وفق تقويم أم القرى الرسمي.',
      },
      {
        q: 'متى يبدأ شهر رمضان 1448هـ؟',
        a: 'يُتوقع أن يبدأ شهر رمضان المبارك 1448هـ في 1 رمضان 1448هـ الموافق 8 فبراير 2027م تقريباً، ويُؤكد ذلك برؤية الهلال رسمياً.',
      },
      {
        q: 'متى عيد الفطر 1448هـ؟',
        a: 'يبدأ عيد الفطر المبارك 1448هـ في 1 شوال 1448هـ الموافق 9 مارس 2027م تقريباً. الإجازة الرسمية تستمر 4 أيام.',
      },
      {
        q: 'متى عيد الأضحى 1448هـ؟',
        a: 'يبدأ عيد الأضحى المبارك 1448هـ في 10 ذو الحجة 1448هـ الموافق 16 مايو 2027م تقريباً. الإجازة الرسمية تستمر 4 أيام تشمل وقفة عرفة.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: 'يصادف اليوم الوطني السعودي 23 سبتمبر من كل عام ميلادي. في 2026م يوافق 12 ربيع الآخر 1448هـ، وهو إجازة رسمية.',
      },
      {
        q: 'متى يوم التأسيس السعودي 1448؟',
        a: 'يصادف يوم التأسيس السعودي 22 فبراير من كل عام ميلادي. في 2027م يوافق 15 رمضان 1448هـ، وهو إجازة رسمية.',
      },
      {
