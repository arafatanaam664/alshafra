...
const OVERRIDES = {
  ...
  '/countdown': 'كم باقي على رمضان والمناسبات',
  ...
  '/faq': 'أسئلة شائعة عن التقويم والمواعيد',
  '/about': 'عن Alshafra',
